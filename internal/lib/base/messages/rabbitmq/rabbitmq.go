...
func CreateRabbitMQManager(managerID, user, password, server, vhost string, port uint16) (*RabbitMQManager, error) {
...
func (man *RabbitMQManager) AddProducer(producerId, queueName string) error {
...
func (obj *RabbitMessageProducer) ProduceMessage(key, value []byte, headers map[string]interface{}) error {
